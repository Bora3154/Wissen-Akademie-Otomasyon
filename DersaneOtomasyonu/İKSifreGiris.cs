...
{
    public partial class İKSifreGiris :Form
    {
        public İKSifreGiris()
        {
            InitializeComponent();
        ...
        private void İKSifreGiris_Load(object sender, EventArgs e)
        {
            this.Top = 250;
            this.Left = 450;
        ...
        {
            if (txtKullanıcıAdi.Text.ToLower() == "bora" && txtSifre.Text.ToLower() == "bora662")
            {
