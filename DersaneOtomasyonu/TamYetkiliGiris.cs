...
{
    public partial class TamYetkiliGiris : Form
    {
        public TamYetkiliGiris()
        {
            InitializeComponent();
        }

        private void TamYetkiliGiris_Load(object sender, EventArgs e)
        {
            this.Top = 250;
            this.Left = 450;
        ...
        private void btnGiris_Click(object sender, EventArgs e)
        {
            ...
            if (txtKullanıcıAdi.Text.ToLower() == "bora" && txtSifre.Text.ToLower() == "bora3154")
            {
